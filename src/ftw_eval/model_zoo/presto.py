...
defer implementation to and ``verify_install.py`` skips this model by
default for . The wrapper below is structurally complete (load() works,
...
class PrestoFoundationModel(FoundationModel):
    ...
    def preprocess(self, chip: Chip) -> dict[str, torch.Tensor]:
        # TODO: implement the canonical chip → Presto dataops layout.
        # The adapter must:
        ...
        raise NotImplementedError(
            "Presto preprocess() is a deliverable. "
    ...
    def encode(
        ...
        # Implemented in alongside preprocess().
