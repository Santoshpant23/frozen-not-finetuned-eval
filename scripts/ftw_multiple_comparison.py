...
json.dump({"n_tests":m,"all_significant_BH_and_Holm":allsig,"min_z":round(min(t[4] for t in tests),2),"tests":out},
          open("data/results/ftw_multiple_comparison.json","w"),indent=2)
